    ...
    return ( 
        <div className={styles.container}>
            <nav className={styles.nav}>
                ...
                <div className={isMobileMenuVisible ? styles.navListContainer : `${styles.navListContainer} ${styles.hide}`}>
