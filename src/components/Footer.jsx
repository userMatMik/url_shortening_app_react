        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                <div className={ styles.footerElements }>
                    <svg xmlns="http://www.w3.org/2000/svg" width="121" height="33" className={styles.footerLogo}>
